Task 2.1: Collect social media data using an API
...
Copy code
pip install tweepy
Create a Python script to collect tweets related to a specific keyword or hashtag:
python
Copy code
import tweepy
import csv
...
Replace your_hashtag with your desired hashtag and run the script to collect the tweets.

Task 2.2: Load and explore the dataset to understand the content and features
...
Task 5.1: Test the model using the testing dataset
